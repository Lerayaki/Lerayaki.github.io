...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "card" }, _attrs))}><div class="name gradient-text">JOSUE</div><div class="surname gradient-text">LERA</div><div class="extension gradient-text">.DEV</div></div>`);
}
